...
#ifndef POP_HYBRID_PROCESS_EFFICIENCY_TEST_H
#define POP_HYBRID_PROCESS_EFFICIENCY_TEST_H
...
namespace advisor
{
class POPHybridProcessEfficiencyTest : public PerformanceTest
{
private:
...
protected:
    ...
    {
        return ( isActive() ) ?
               QString::fromStdString( "AdvisorPOPHybridTestsProcess_efficiency.html" ) :
               QString::fromStdString( "AdvisorPOPHybridTestsMissing_process_efficiency.html" );
    }
