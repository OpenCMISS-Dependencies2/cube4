...
#ifndef JSC_SERIALISATION_TEST_H
#define JSC_SERIALISATION_TEST_H
...
namespace advisor
{
class JSCSerialisationTest : public PerformanceTest
{
private:
...
protected:
    ...
    {
        return ( isActive() ) ?
               QString::fromStdString( "AdvisorJSCTestsSerialisation_efficiency.html" ) :
               QString::fromStdString( "AdvisorJSCTestsMissing_serialisation_efficiency.html" );
    }
...
public:
    JSCSerialisationTest( cube::CubeProxy* );

    virtual
    ~JSCSerialisationTest()
    {
    };
