...
#ifndef POP_NO_WAIT_INS_TEST_H
#define POP_NO_WAIT_INS_TEST_H
...
protected:
    ...
    {
        return ( isActive() ) ?
               QString::fromStdString( "AdvisorPOPTestsNoWaitINS_efficiency.html" ) :
               QString::fromStdString( "AdvisorPOPTestsMissingNoWaitINS_efficiency.html" );
    }
