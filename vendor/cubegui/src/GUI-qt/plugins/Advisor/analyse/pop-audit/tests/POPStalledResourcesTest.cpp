...
void
POPStalledResourcesTest::applyCnode( const cube::Cnode* cnode, const cube::CalculationFlavour cnf,
...
void
POPStalledResourcesTest::add_stalled_resources( cube::CubeProxy* cube ) const
{
...
void
POPStalledResourcesTest::add_res_stl_without_wait( cube::CubeProxy* cube ) const
{
...
void
POPStalledResourcesTest::add_tot_cyc_without_wait( cube::CubeProxy* cube )  const
{
