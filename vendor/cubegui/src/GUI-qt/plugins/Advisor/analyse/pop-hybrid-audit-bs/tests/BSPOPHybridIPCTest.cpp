...
BSPOPHybridIPCTest::BSPOPHybridIPCTest( cube::CubeProxy* cube ) : PerformanceTest( cube )
{
...
void
BSPOPHybridIPCTest::applyCnode( const cube::Cnode* cnode, const cube::CalculationFlavour cnf,
...
void
BSPOPHybridIPCTest::applyCnode( const cube::list_of_cnodes& lcnodes,
                                const bool                  direct_calculation  )
{
    ( void )direct_calculation; // not used here
    if ( pop_ipc == nullptr )
...
const std::string&
BSPOPHybridIPCTest::getCommentText() const
{
    if ( pop_ipc == nullptr )
    {
        return no_comment;
...
bool
BSPOPHybridIPCTest::isActive() const
{
    return pop_ipc != nullptr;
};

bool
BSPOPHybridIPCTest::isIssue() const
{
    return false;
};
...
void
BSPOPHybridIPCTest::adjustForTest( cube::CubeProxy* cube ) const
{
...
void
BSPOPHybridIPCTest::add_ipc( cube::CubeProxy* cube ) const
{
...
void
BSPOPHybridIPCTest::add_tot_ins_without_wait( cube::CubeProxy* cube ) const
{
...
void
BSPOPHybridIPCTest::add_tot_cyc_without_wait( cube::CubeProxy* cube )  const
{
