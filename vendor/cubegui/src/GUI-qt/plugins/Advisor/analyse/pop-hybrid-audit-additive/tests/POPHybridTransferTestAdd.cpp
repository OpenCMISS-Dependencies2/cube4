...
POPHybridTransferTestAdd::POPHybridTransferTestAdd( cube::CubeProxy* cube ) : PerformanceTest( cube )
{
...
void
POPHybridTransferTestAdd::applyCnode( const cube::Cnode*, const cube::CalculationFlavour,
                                      const bool )
{
}

void
POPHybridTransferTestAdd::applyCnode( const cube::list_of_cnodes& cnodes,
...
double
POPHybridTransferTestAdd::analyze( const cube::list_of_cnodes& cnodes,
...
const std::string&
POPHybridTransferTestAdd::getCommentText() const
{
    if ( pop_transfer == nullptr )
    {
        return no_comment;
...
bool
POPHybridTransferTestAdd::isActive() const
{
    return pop_transfer != nullptr;
};

bool
POPHybridTransferTestAdd::isIssue() const
{
    return false;
};

void
POPHybridTransferTestAdd::adjustForTest( cube::CubeProxy* cube ) const
{
...
void
POPHybridTransferTestAdd::add_transfer_eff( cube::CubeProxy* ) const
{
...
void
POPHybridTransferTestAdd::add_max_total_time_ideal( cube::CubeProxy* ) const
{
...
void
POPHybridTransferTestAdd::add_max_total_time( cube::CubeProxy* ) const
{
    add_execution_time( cube );
