...
POPSerialisationTest::POPSerialisationTest( cube::CubeProxy* cube ) : PerformanceTest( cube )
{
...
void
POPSerialisationTest::applyCnode( const cube::Cnode*, const cube::CalculationFlavour,
                                  const bool )
{
    if ( max_total_time_ideal == nullptr || comp_time == nullptr )
    {
