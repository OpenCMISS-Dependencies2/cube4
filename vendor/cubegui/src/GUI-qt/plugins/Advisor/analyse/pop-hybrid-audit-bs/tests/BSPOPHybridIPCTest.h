...
#ifndef BSPOP_HYBRID_IPC_TEST_H
#define BSPOP_HYBRID_IPC_TEST_H
...
namespace advisor
{
class BSPOPHybridIPCTest : public PerformanceTest
{
private:
    cube::Metric* pop_ipc;
    double        maxValue;
...
protected:
    ...
    {
        return ( isActive() ) ?
               QString::fromStdString( "AdvisorBSPOPHybridTestsIpc.html" ) :
               QString::fromStdString( "AdvisorBSPOPHybridTestsMissing_ipc.html" );
    }
...
public:
    BSPOPHybridIPCTest( cube::CubeProxy* );
