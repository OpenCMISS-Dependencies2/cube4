...
#ifndef JSC_STALLED_RESOURCES_TEST_H
#define JSC_STALLED_RESOURCES_TEST_H
...
namespace advisor
{
class JSCStalledResourcesTest : public PerformanceTest
{
private:
...
protected:
    ...
    {
        return ( isActive() ) ?
               QString::fromStdString( "AdvisorJSCTestsStalled_resources.html" ) :
               QString::fromStdString( "AdvisorJSCTestsMissing_stalled_resources.html" );
    }
...
public:
    JSCStalledResourcesTest( cube::CubeProxy* );

    virtual
    ~JSCStalledResourcesTest()
    {
    };
...
#endif // JSC_stalled_resources_TEST_H
