...
POPHybridIPCTest::POPHybridIPCTest( cube::CubeProxy* cube ) : PerformanceTest( cube )
{
...
void
POPHybridIPCTest::applyCnode( const cube::Cnode* cnode, const cube::CalculationFlavour cnf,
...
void
POPHybridIPCTest::applyCnode( const cube::list_of_cnodes& lcnodes,
                              const bool                  direct_calculation  )
{
    ( void )direct_calculation; // not used here
    if ( pop_ipc == nullptr )
...
const std::string&
POPHybridIPCTest::getCommentText() const
{
    if ( pop_ipc == nullptr )
    {
        return no_comment;
...
bool
POPHybridIPCTest::isActive() const
{
    return pop_ipc != nullptr;
};

bool
POPHybridIPCTest::isIssue() const
{
    return false;
};
...
void
POPHybridIPCTest::adjustForTest( cube::CubeProxy* cube ) const
{
...
void
POPHybridIPCTest::add_ipc( cube::CubeProxy* cube ) const
{
...
void
POPHybridIPCTest::add_tot_ins_without_wait( cube::CubeProxy* cube ) const
{
...
void
POPHybridIPCTest::add_tot_cyc_without_wait( cube::CubeProxy* cube )  const
{
