...
POPHybridAuditPerformanceAnalysis::POPHybridAuditPerformanceAnalysis( cube::CubeProxy* _cube ) : PerformanceAnalysis( _cube )
{
    stalled_resources = new POPHybridStalledResourcesTest( cube );
    ipc               = new POPHybridIPCTest( cube );
    no_wait_ins       = new POPHybridNoWaitINSTest( cube );
    comp              = new POPHybridComputationTime( cube );
...
QList<AdvisorAdvice>
POPHybridAuditPerformanceAnalysis::getCandidates( const QList<TreeItem*>& _list )
{
...
POPHybridAuditPerformanceAnalysis::getPerformanceTests()
{
