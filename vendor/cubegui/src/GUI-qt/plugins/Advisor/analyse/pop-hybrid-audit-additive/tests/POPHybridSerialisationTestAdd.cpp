...
POPHybridSerialisationTestAdd::POPHybridSerialisationTestAdd( cube::CubeProxy* cube ) : PerformanceTest( cube )
{
...
void
POPHybridSerialisationTestAdd::applyCnode( const cube::Cnode*, const cube::CalculationFlavour,
                                           const bool )
{
}
