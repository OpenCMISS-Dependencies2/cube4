...
#ifndef POP_HYBRID_TRANSFER_TEST_H
#define POP_HYBRID_TRANSFER_TEST_H
...
namespace advisor
{
class POPHybridTransferTest : public PerformanceTest
{
private:
...
protected:
    ...
    {
        return ( isActive() ) ?
               QString::fromStdString( "AdvisorPOPHybridTestsTransfer_efficiency.html" ) :
               QString::fromStdString( "AdvisorPOPHybridTestsMissing_transfer_efficiency.html" );
    }
