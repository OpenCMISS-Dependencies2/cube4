...
#ifndef JSC_IPC_TEST_H
#define JSC_IPC_TEST_H
...
namespace advisor
{
class JSCIPCTest : public PerformanceTest
{
private:
    cube::Metric* pop_ipc;
    double        maxValue;
...
protected:
    ...
    {
        return ( isActive() ) ?
               QString::fromStdString( "AdvisorJSCTestsIpc.html" ) :
               QString::fromStdString( "AdvisorJSCTestsMissing_ipc.html" );
    }
