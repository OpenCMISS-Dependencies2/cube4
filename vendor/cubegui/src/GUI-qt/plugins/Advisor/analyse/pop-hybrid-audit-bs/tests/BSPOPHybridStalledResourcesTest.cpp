...
BSPOPHybridStalledResourcesTest::BSPOPHybridStalledResourcesTest( cube::CubeProxy* cube ) : PerformanceTest( cube )
{
...
void
BSPOPHybridStalledResourcesTest::applyCnode( const cube::Cnode* cnode, const cube::CalculationFlavour cnf,
...
void
BSPOPHybridStalledResourcesTest::applyCnode( const cube::list_of_cnodes& lcnodes,
                                             const bool                  direct_calculation  )
{
    ( void )direct_calculation; // not used here
    if ( pop_stalled_resources == nullptr )
...
const std::string&
BSPOPHybridStalledResourcesTest::getCommentText() const
{
    if ( pop_stalled_resources == nullptr )
    {
        return no_comment;
...
bool
BSPOPHybridStalledResourcesTest::isActive() const
{
    return pop_stalled_resources != nullptr;
};

bool
BSPOPHybridStalledResourcesTest::isIssue() const
{
    return false;
};
...
void
BSPOPHybridStalledResourcesTest::adjustForTest( cube::CubeProxy* cube ) const
{
...
void
BSPOPHybridStalledResourcesTest::add_stalled_resources( cube::CubeProxy* cube ) const
{
...
void
BSPOPHybridStalledResourcesTest::add_res_stl_without_wait( cube::CubeProxy* cube ) const
{
...
void
BSPOPHybridStalledResourcesTest::add_tot_cyc_without_wait( cube::CubeProxy* cube )  const
{
