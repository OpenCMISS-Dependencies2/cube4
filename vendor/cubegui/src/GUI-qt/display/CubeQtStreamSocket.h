 ...
 *  @brief   Declaration of the class cube::QtStreamSocket
 **/
/*-------------------------------------------------------------------------*/


#ifndef CUBE_QTSTREAMSOCKET_H
#define CUBE_QTSTREAMSOCKET_H
...
/*-------------------------------------------------------------------------*/
/**
 *  @class   cube::QtStreamSocket
 *  @ingroup CUBE_gui.network
 *  @brief   A Qt-based stream socket.
 **/
/*-------------------------------------------------------------------------*/

class QtStreamSocket
