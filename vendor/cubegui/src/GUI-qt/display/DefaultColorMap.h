...
class DefaultColorMap : public ColorMap, public InternalSettingsHandler
{
    Q_OBJECT
public:
    DefaultColorMap();
...
private:
    ...
    // copy of config dialog values
    double         whiteStartCopy;
    double         lightenStartCopy;
    double         colorPosCopy[ 5 ];
    ColoringMethod coloringMethodCopy;
...
private:
    QList<ColoringMethod> colorMethods;

    QList<QDoubleSpinBox*> spin;
    QList<QRadioButton*>   colorButton;
    QDoubleSpinBox*        lightenStartSpin;
    QDoubleSpinBox*        whiteStartSpin;
    ColorWidget*           colorWidget;
