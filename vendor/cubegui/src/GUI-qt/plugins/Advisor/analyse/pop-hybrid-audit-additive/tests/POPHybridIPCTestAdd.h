...
#ifndef POP_HYBRID_IPC_TEST_ADD_H
#define POP_HYBRID_IPC_TEST_ADD_H
...
namespace advisor
{
class POPHybridIPCTestAdd : public PerformanceTest
{
private:
    cube::Metric* pop_ipc;
    double        maxValue;
...
protected:
    ...
    {
        return ( isActive() ) ?
               QString::fromStdString( "AdvisorPOPHybridAddTestsIpc.html" ) :
               QString::fromStdString( "AdvisorPOPHybridAddTestsMissing_ipc.html" );
    }
...
public:
    POPHybridIPCTestAdd( cube::CubeProxy* );
