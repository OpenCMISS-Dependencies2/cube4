...
POPHybridProcessEfficiencyTestAdd::POPHybridProcessEfficiencyTestAdd( cube::CubeProxy*                         cube,
                                                                      POPHybridImbalanceTestAdd*               _pop_lb,
                                                                      POPHybridCommunicationEfficiencyTestAdd* _pop_commeff ) :
...
void
POPHybridProcessEfficiencyTestAdd::calculate( const cube::list_of_cnodes& cnodes )
{
...
void
POPHybridProcessEfficiencyTestAdd::calculate()
{
    if ( pop_lb == nullptr || pop_commeff == nullptr )
    {
        return;
    ...
    setValue( ( ( pop_lb->isActive() ) ? lb_eff_value : 1. ) +
              ( ( pop_commeff->isActive() ) ? comm_eff_value : 1. ) - 1 );
}

void
POPHybridProcessEfficiencyTestAdd::applyCnode( const cube::Cnode* cnode, const cube::CalculationFlavour cnf,
...
void
POPHybridProcessEfficiencyTestAdd::applyCnode( const cube::list_of_cnodes& cnodes,
                                               const bool                  direct_calculation  )
{
...
const std::string&
POPHybridProcessEfficiencyTestAdd::getCommentText() const
{
    if ( pop_lb == nullptr || pop_commeff == nullptr )
    {
        return no_comment;
...
bool
POPHybridProcessEfficiencyTestAdd::isActive() const
{
...
bool
POPHybridProcessEfficiencyTestAdd::isIssue() const
{
    return false;
};
...
void
POPHybridProcessEfficiencyTestAdd::adjustForTest( cube::CubeProxy* cube ) const
{
    ( void )cube;
}
