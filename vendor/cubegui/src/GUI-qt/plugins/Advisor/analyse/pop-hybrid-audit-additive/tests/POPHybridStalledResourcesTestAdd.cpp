...
POPHybridStalledResourcesTestAdd::POPHybridStalledResourcesTestAdd( cube::CubeProxy* cube ) : PerformanceTest( cube )
{
...
void
POPHybridStalledResourcesTestAdd::applyCnode( const cube::Cnode* cnode, const cube::CalculationFlavour cnf,
...
void
POPHybridStalledResourcesTestAdd::applyCnode( const cube::list_of_cnodes& lcnodes,
                                              const bool                  direct_calculation  )
{
    ( void )direct_calculation; // not used here
    if ( pop_stalled_resources == nullptr )
...
const std::string&
POPHybridStalledResourcesTestAdd::getCommentText() const
{
    if ( pop_stalled_resources == nullptr )
    {
        return no_comment;
...
bool
POPHybridStalledResourcesTestAdd::isActive() const
{
    return pop_stalled_resources != nullptr;
};

bool
POPHybridStalledResourcesTestAdd::isIssue() const
{
    return false;
};
...
void
POPHybridStalledResourcesTestAdd::adjustForTest( cube::CubeProxy* cube ) const
{
...
void
POPHybridStalledResourcesTestAdd::add_stalled_resources( cube::CubeProxy* cube ) const
{
...
void
POPHybridStalledResourcesTestAdd::add_res_stl_without_wait( cube::CubeProxy* cube ) const
{
...
void
POPHybridStalledResourcesTestAdd::add_tot_cyc_without_wait( cube::CubeProxy* cube )  const
{
