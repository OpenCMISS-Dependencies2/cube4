...
cubelib_config_get_frontend_data( void )
{
    ...
    data.m_cc                    = " gcc";
    data.m_cxx                   = " g++";
    data.m_cppflags              = "-I/home/builder/builder/atlantis/builds/ByzjsFMR/0/perftools/addons/cube/supplements/bundle/CubeBundle-/vpath/_install/include/cubelib";
    data.m_incldir               = "/home/builder/builder/atlantis/builds/ByzjsFMR/0/perftools/addons/cube/supplements/bundle/CubeBundle-/vpath/_install/include/cubelib";
