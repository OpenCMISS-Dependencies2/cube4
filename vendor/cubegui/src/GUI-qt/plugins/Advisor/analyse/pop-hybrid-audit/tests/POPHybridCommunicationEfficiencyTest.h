...
#ifndef POP_HYBRID_COMMUNICATION_EFFICENCY_TEST_H
#define POP_HYBRID_COMMUNICATION_EFFICENCY_TEST_H
...
namespace advisor
{
class POPHybridCommunicationEfficiencyTest : public PerformanceTest
{
private:
...
protected:
    ...
    {
        return ( isActive() ) ?
               QString::fromStdString( "AdvisorPOPHybridTestsCommunication_efficiency.html" ) :
               QString::fromStdString( "AdvisorPOPHybridTestsMissing_communication_efficiency.html" );
    }
