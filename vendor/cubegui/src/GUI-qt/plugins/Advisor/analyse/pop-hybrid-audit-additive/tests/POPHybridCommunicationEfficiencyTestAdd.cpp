...
POPHybridCommunicationEfficiencyTestAdd::POPHybridCommunicationEfficiencyTestAdd( cube::CubeProxy*               cube,
                                                                                  POPHybridSerialisationTestAdd* _pop_ser,
                                                                                  POPHybridTransferTestAdd*      _pop_transeff ) : PerformanceTest( cube ),
    pop_ser( _pop_ser ),
...
double
POPHybridCommunicationEfficiencyTestAdd::calculateForScout( const cube::list_of_cnodes& cnodes ) const
{
...
void
POPHybridCommunicationEfficiencyTestAdd::applyCnode( const cube::Cnode*, const cube::CalculationFlavour,
                                                     const bool )
{
}

void
POPHybridCommunicationEfficiencyTestAdd::applyCnode( const cube::list_of_cnodes& cnodes,
...
double
POPHybridCommunicationEfficiencyTestAdd::analyze( const cube::list_of_cnodes& cnodes,
...
const std::string&
POPHybridCommunicationEfficiencyTestAdd::getCommentText() const
{
    if ( pop_ser == nullptr || pop_transeff == nullptr )
    {
        return no_comment;
...
bool
POPHybridCommunicationEfficiencyTestAdd::isActive() const
{
...
bool
POPHybridCommunicationEfficiencyTestAdd::isIssue() const
{
    return false;
};

void
POPHybridCommunicationEfficiencyTestAdd::adjustForTest( cube::CubeProxy* cube ) const
{
