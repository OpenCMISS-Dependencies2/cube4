...
#ifndef POP_HYBRID_SERIALISATION_TEST_ADD_H
#define POP_HYBRID_SERIALISATION_TEST_ADD_H
...
namespace advisor
{
class POPHybridSerialisationTestAdd : public PerformanceTest
{
private:
...
protected:
    ...
    {
        return ( isActive() ) ?
               QString::fromStdString( "AdvisorPOPHybridAddTestsSerialisation_efficiency.html" ) :
               QString::fromStdString( "AdvisorPOPHybridAddTestsMissing_serialisation_efficiency.html" );
    }
