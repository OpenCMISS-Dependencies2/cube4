...
#ifndef BSPOP_HYBRID_MPI_TRANSFER_TEST_H
#define BSPOP_HYBRID_MPI_TRANSFER_TEST_H
...
namespace advisor
{
class BSPOPHybridMPITransferTest : public PerformanceTest
{
private:
...
protected:
    ...
    {
        return ( isActive() ) ?
               QString::fromStdString( "AdvisorBSPOPHybridTestsMPITransfer_efficiency.html" ) :
               QString::fromStdString( "AdvisorBSPOPHybridTestsMissing_transfer_efficiency.html" );
    }
